...
def main():
    ...
    forward_button['command'] = lambda: robot.(mqtt_client, left_speed_entry, right_speed_entry)
    root.bind('<Up>', lambda event: robot.button_forward(mqtt_client, left_speed_entry, right_speed_entry))
