...
Much like we did in troncicc of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    while True:
        ...
        time.sleep(0.01)  # short break before loop starts again
