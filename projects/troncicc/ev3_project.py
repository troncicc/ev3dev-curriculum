...
Kelly:
     Oh no! You have become trapped by Kelly's endless conversation about the latest celebrity gossip.
     Back away SLOWLY so she doesn't notice that you're gone.
     if speed
     (success = happy + 100)
     (failure = happy - 100)
