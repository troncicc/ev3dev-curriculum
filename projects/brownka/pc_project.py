...
def main():
    ...
    black['command'] = lambda: mqtt_client.send_message("calibrate_black")
    white = ttk.Button(main_frame, text="Calibrate Black")
    white.grid(row=2, column=3)
    white['command'] = lambda: mqtt_client.send_message("calibrate_white")
